...
/**
 * This is the item provider adapter for a {@link formModeler.Lien} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LienItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Lien_cible_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Lien_cible_feature", "_UI_Lien_type"),
				 FormModelerPackage.Literals.LIEN__CIBLE,
				 true,
				 false,
				 false,
	...
	protected void addValeurPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Lien_valeur_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Lien_valeur_feature", "_UI_Lien_type"),
				 FormModelerPackage.Literals.LIEN__VALEUR,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		String label = ((Lien)object).getNom();
