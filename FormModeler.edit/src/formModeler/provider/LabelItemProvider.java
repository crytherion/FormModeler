...
/**
 * This is the item provider adapter for a {@link formModeler.Label} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LabelItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Label_valeur_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Label_valeur_feature", "_UI_Label_type"),
				 FormModelerPackage.Literals.LABEL__VALEUR,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Label)object).getNom();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Label.class)) {
			case FormModelerPackage.LABEL__VALEUR:
